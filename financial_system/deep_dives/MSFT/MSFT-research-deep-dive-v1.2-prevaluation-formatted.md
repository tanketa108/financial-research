# Microsoft Corporation (MSFT) — Research Deep Dive v1.2
...
- [5A. Financials históricos: perspectiva 5 años](#5a-financials-histricos-perspectiva-5-aos)
...
- [15. Bibliografía y fuentes](#15-bibliografa-y-fuentes)
...
## 5A. Financials históricos: perspectiva 5 años

La perspectiva histórica debe cubrir **5 años** como estándar metodológico: suficiente para ver tendencia, mix, márgenes, caja, capex y balance sin convertir el research pre-valoración en una base de datos histórica. En Microsoft, la lectura central es clara: margen operativo excelente, balance sólido y una ruptura reciente en intensidad de capital por AI/cloud.
...
![5-year revenue, operating income and FCF](charts/msft_5y_revenue_opincome_fcf.svg)

Lectura:

- Revenue crece de $168.1bn en FY2021 a $281.7bn en FY2025.
- Operating income crece de $69.9bn a $128.5bn, con margen operativo sostenido por encima del 40% desde FY2021.
- FCF sube de $56.1bn a $71.6bn, pero queda por debajo del pico FY2024 pese al crecimiento de earnings.
- Capex/revenue pasa de ~12% en FY2021-FY2022 a 18.1% en FY2024 y 22.9% en FY2025. Esta es la ruptura estructural que debe dominar la valoración.

![5-year capex intensity and FCF conversion](charts/msft_5y_capex_fcf_conversion.svg)
...
- Equity crece de $142.0bn a $343.5bn, reduciendo deuda/equity hacia 0.13x.
...
La historia financiera de 5 años muestra dos regímenes:

1. **FY2021–FY2023:** cloud/software con capex todavía relativamente controlado y FCF robusto.
2. **FY2024–FY2026:** AI/cloud infrastructure cycle, con margen todavía excelente pero FCF más tensionado por capex.

La valoración no debe asumir que FY2025 es deterioro permanente, pero tampoco que el régimen FY2021–FY2023 vuelve automáticamente. El caso depende de si el capex actual crea una base de ingresos suficientemente rentable para volver a elevar FCF conversion.
