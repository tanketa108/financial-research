...
- 2Y trend: `rising`; 10Y trend: `rising`; 10Y-2Y curve trend: `falling`.
- Latest rates/spreads:
  - FEDFUNDS — Effective Federal Funds Rate: **3.63%** on 2026-05-01; one-period change: **-0.01pp**; 17-obs trend: **-0.70pp**.
  - DGS2 — Market Yield on U.S. Treasury Securities at 2-Year Constant Maturity: **4.05%** on 2026-06-02; one-period change: **0.00pp**; 120-obs trend: **+0.51pp**.
  - DGS10 — Market Yield on U.S. Treasury Securities at 10-Year Constant Maturity: **4.46%** on 2026-06-02; one-period change: **-0.01pp**; 120-obs trend: **+0.33pp**.
  - DGS30 — Market Yield on U.S. Treasury Securities at 30-Year Constant Maturity: **4.97%** on 2026-06-02; one-period change: **-0.02pp**; 120-obs trend: **+0.19pp**.
  - T10Y2Y — 10-Year Treasury Constant Maturity Minus 2-Year Treasury Constant Maturity: **0.41%** on 2026-06-02; one-period change: **-0.01pp**; 120-obs trend: **-0.18pp**.
  - T10Y3M — 10-Year Treasury Constant Maturity Minus 3-Month Treasury Constant Maturity: **0.69%** on 2026-06-02; one-period change: **0.00pp**; 120-obs trend: **+0.25pp**.
- Source URLs:
  - FEDFUNDS: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=FEDFUNDS&cosd=2025-01-01>
  - DGS2: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=DGS2&cosd=2025-01-01>
  - DGS10: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=DGS10&cosd=2025-01-01>
  - DGS30: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=DGS30&cosd=2025-01-01>
  - T10Y2Y: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=T10Y2Y&cosd=2025-01-01>
  - T10Y3M: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=T10Y3M&cosd=2025-01-01>
...
- Policy expectations signal: **rates are rising across front and long end; valuation duration sensitivity should be monitored.**
...
- Source URLs:
  - CPIAUCSL: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=CPIAUCSL&cosd=2025-01-01>
  - CPILFESL: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=CPILFESL&cosd=2025-01-01>
  - PCEPI: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=PCEPI&cosd=2025-01-01>
  - PCEPILFE: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=PCEPILFE&cosd=2025-01-01>
...
- ICSA — Initial Claims: **215,000** persons on 2026-05-23; one-period change: **5,000**; window direction: `falling`.
- JTSJOL — Job Openings: Total Nonfarm: **7,618** thousands on 2026-04-01; one-period change: **731**; window direction: `rising`.
- Source URLs:
  - PAYEMS: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=PAYEMS&cosd=2025-01-01>
  - UNRATE: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=UNRATE&cosd=2025-01-01>
  - CIVPART: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=CIVPART&cosd=2025-01-01>
  - CES0500000003: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=CES0500000003&cosd=2025-01-01>
  - ICSA: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=ICSA&cosd=2025-01-01>
  - JTSJOL: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=JTSJOL&cosd=2025-01-01>
...
- Source URLs:
  - GDPC1: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=GDPC1&cosd=2025-01-01>
  - PCECC96: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=PCECC96&cosd=2025-01-01>
  - RSXFS: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=RSXFS&cosd=2025-01-01>
  - RRSFS: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=RRSFS&cosd=2025-01-01>
  - INDPRO: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=INDPRO&cosd=2025-01-01>
  - HOUST: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=HOUST&cosd=2025-01-01>
  - PERMIT: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=PERMIT&cosd=2025-01-01>
  - DGORDER: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=DGORDER&cosd=2025-01-01>
  - NEWORDER: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=NEWORDER&cosd=2025-01-01>
- Caveat: FRED values are revised series; no consensus/surprise or release-vintage claims are made.
...
- Source: Treasury FiscalData Daily Treasury Statement; record date: **2026-06-02**; units: `USD millions`.
- TGA opening balance: **$856,842mn**.
- Total TGA deposits: **$263,280mn**.
- Total TGA withdrawals: **$254,047mn**.
- TGA one-day change: **-$47,039mn** vs prior available DTS record.
- TGA 60-record trend (2026-03-10 → 2026-06-02): **-$1,706mn**; direction: `falling`.
- Recent TGA history, latest first:
  - 2026-06-02: $856,842mn
...
NY Fed reverse repo:
- Source: NY Fed Markets API; latest operation date: **2026-06-03**; units: `USD billions`.
- Total accepted RRP amount: **$2.062bn**.
- Accepted counterparties: **35.0**; award/offering rate: **3.5%**.
- RRP one-day change: **-$0.440bn** vs prior available operation.
- RRP 90-operation trend (2026-01-27 → 2026-06-03): **+$0.809bn**; direction: `rising`.
- Recent RRP history, latest first:
  ...
  - 2026-05-29: $11.677bn
  - 2026-05-28: $1.163bn
- Source URL: <https://markets.newyorkfed.org/api/rp/reverserepo/all/results/last/90.csv>
...
- Reserve balances 74-observation trend (2025-01-01 → 2026-05-27): **-$29,437mn**; direction: `falling`.
...
- Source URL: <https://fred.stlouisfed.org/graph/fredgraph.csv?id=WRESBAL&cosd=2025-01-01>
...
- Automatic liquidity read: **mixed liquidity context: falling TGA adds cash, but RRP is not clearly reinforcing that impulse.**
- Inputs: TGA trend `falling` (-$1,706mn over window); RRP trend `rising` (+$0.809bn over window).
- Cross-check: reserve balances trend `falling` (-$29,437mn over window). This is the direct balance-sheet confirmation leg for the TGA/RRP read.
- Portfolio use: monitor persistence before drawing conclusions.
...
- Key numbers to carry into portfolio review: 10Y **4.46%**; 10Y-2Y **0.41%**; core PCE YoY **3.29%**; unemployment **4.30%**; real GDP QoQ **+0.40%**.
